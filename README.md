...
* **/src**: React source code, including `App.jsx` and `Login.jsx` components.
* **/assets**: Technical diagrams including:
    * High-Level System Architecture
    * Information Architecture (IA) Map
    * Project Sitemap & Use Case Diagrams
* **/docs**: Administrative and planning artifacts:
    * Sprint Planners (Excel/CSV)
    * Group Project Specification Document
    * Testing & Validation Reports

## Tech Stack
* **Frontend**: React.js, Tailwind CSS
* **Backend**: SQL, JWT Authentication
